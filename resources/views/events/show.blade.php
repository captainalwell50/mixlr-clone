...
@section('content')
    <div class="stage stage-cinema portal" style="--stage-accent: {{ $theme }}; --stage-art: url('{{ $stageArt }}')">
        ...
        <div class="stage-shell">
            ...
            <div class="portal-layout {{ $event->chat_enabled ? 'has-chat' : '' }}" id="portal-layout">
                <main class="portal-main">
                    <div class="portal-art stage-rise-delay" style="background-image: url('{{ $stageArt }}')" role="img" aria-label="Event artwork"></div>
