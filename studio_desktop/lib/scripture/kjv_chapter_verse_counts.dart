// Auto-derived from database/data/bible/en_kjv.json — chapter verse counts.
// Do not edit by hand; regenerate if the KJV data changes.

const Map<String, List<int>> kjvChapterVerseCounts = {
