...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | After migrate --seed, the user with this email receives is_admin = true.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Allow public registration (/register). Keep false for private church setups.
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Public support contact (App Store / Play Store / in-app legal pages)
    |--------------------------------------------------------------------------
    */

    'support_email' => env('SUPPORT_EMAIL', 'support@soundmix.live'),
